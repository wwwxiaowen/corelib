...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSArray *images = @[[UIImage imageNamed:@"share-weixin@3x.png"],
                            [UIImage imageNamed:@"share-weixin-frends@3x.png"],
                            [UIImage imageNamed:@"share-qq@3x.png"],
                            [UIImage imageNamed:@"share-qqzone@3x.png"],
                            [UIImage imageNamed:@"share-weibo@3x.png"]];
        NSInteger rank = 0;
